...
int main() {
  ...
  for(int v : w[city]) {
    ...
    // cout << "index : " << v << endl;
    // cout << "temp[v] : " << temp[y].alpha << endl;
    // cout << "temp[v] : " << temp[y].beta << endl;
    // cout << "temp[v] : " << temp[y].united << endl;
    // cout << "temp[v] : " << temp[y].isalpha << endl;
    // cout << "temp[v] : " << temp[y].isbeta << endl;
